...
import asyncio
from ..repositories.IngredientRepository import select_all, get_ingredient, insert_ingredient, update_ingredient
...
def update_ingredient_service(ingredient: Ingredient):
    return update_ingredient(ingredient)